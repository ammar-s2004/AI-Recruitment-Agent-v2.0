      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col items-center justify-center min-h-screen relative z-10">
        ...
        <div className="text-center space-y-8 max-w-6xl w-full">
          ...
          <motion.div
            ...
            className="inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-5 py-3 text-sm sm:text-base font-medium text-blue-700 shadow-sm"
          >
            AI Recruiter can filter candidates 3.5x better than humans.
          </motion.div>
        </div>
