  ...
  const GetInterviewDetail = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from("interviews")
        .select(
          "jobposition, jobdescription, type, questionlist, duration, interview_id, created_at, interview_results (email, fullname, conversation_transcript, recommendations, interview_id, completed_at, candidate_id, resume_url)"
        )
