...
function FormContainer({ onHandleInputChange, GoToNext }) {
  ...
  return (
    <div className="p-5 bg-white rounded-xl shadow-md">
      ...
      <div className="mt-4">
        <h2 className="text-sm font-medium">Invited Candidate Email (Optional)</h2>
        <Input
          placeholder="email@candidate.com"
          className="mt-2"
          onChange={(event) => {
            onHandleInputChange('candidateEmail', event.target.value);
          }}
        />
        <p className="text-[10px] text-muted-foreground mt-1">If provided, only this email will be able to join the interview.</p>
      </div>
      <div className="mt-4">
